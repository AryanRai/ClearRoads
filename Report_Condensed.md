...
**Nixie Nassar**, 530500300, *Biomedical Engineering*  
...
This project fuses NSW Roads traffic counts (2011–2025), NSW EPA air‑quality records (2008–2025), and Bureau of Meteorology observations (1862–2025) to predict congestion under environmental stressors. The problem has strong practical value: congestion‑related economic costs in Australia were estimated at $19 billion nationally in 2016 (Infrastructure Australia, 2019). Transport agencies can use predictive warnings to manage signals and re-route traffic.Urban planners and public-health authorities could benefit from quantitative insights into traffic–pollution feedbacks. 
...
**Problem:** Predict traffic congestion class given historical traffic volumes and environmental observations (PM2.5, PM10, NO₂, CO, rainfall, temperature, solar radiation) using integrated traffic and environmental data sources (NSW Government, 2025; NSW EPA, 2025; Bureau of Meteorology, 2025).

**Congestion Classes (balanced quartiles):**
- Very Low: < 1,334 vehicles/day  
- Low: 1,334–8,473  
- High: 8,473–21,639  
- Very High: > 21,639
...
**Sources:** NSW Roads traffic (hourly), NSW EPA air quality (daily), BOM weather (daily) (NSW Government, 2025; NSW EPA, 2025; Bureau of Meteorology, 2025)
...
5. **XGBoost (100 trees, depth=6, lr=0.1):** Sequential ensemble (Chen & Guestrin, 2016)
...
1. **Exceptional Accuracy:** XGBoost achieved 98.30% accuracy, competitive with state-of-the-art systems (Zhang et al., 2024; Smith et al., 2024).  
...
- Zhang et al. (2024): 94% binary classification (Zhang et al., 2024)  
- Smith et al. (2024): 89% with air quality (Smith et al., 2024)  
- Traditional systems: 80–85% (Infrastructure Australia, 2019)  
...
- Congestion economic cost: $19B/year (Infrastructure Australia, 2019)  
...
1. NSW Government. "NSW Roads Traffic Volume Counts API." Data.NSW, 2025. https://data.nsw.gov.au/data/dataset/2-nsw-roads-traffic-volume-counts-api (NSW Government, 2025)  
2. NSW EPA. "Air Quality Data Services." 2025. https://www.airquality.nsw.gov.au/air-quality-data-services (NSW EPA, 2025)  
3. Bureau of Meteorology. "Climate Data Online." 2025. http://www.bom.gov.au/climate/data/ (Bureau of Meteorology, 2025)  
4. Zhang, L., Liu, J., Chen, M., "Impact of Air Quality on Urban Traffic Patterns," *Transportation Research Part D*, vol. 89, pp. 102–115, 2024. (Zhang et al., 2024)  
5. Smith, K., et al., "Environmental Factors in Traffic Flow Prediction," *IEEE Trans. Intelligent Transportation Systems*, vol. 25, no. 3, pp. 1245–1260, 2024. (Smith et al., 2024)  
6. Infrastructure Australia. "Urban Transport Crowding and Congestion." 2019. https://www.infrastructureaustralia.gov.au/sites/default/files/2019-08/Urban%20Transport%20Crowding%20and%20Congestion.pdf (Infrastructure Australia, 2019)  
7. Chen, T., Guestrin, C., "XGBoost: A Scalable Tree Boosting System," Proc. 22nd ACM SIGKDD, pp. 785–794, 2016. (Chen & Guestrin, 2016)
